<div class="mb-6 p-4 bg-white rounded shadow">
    ...
    <button id="searchGifButton" class="mt-2 bg-purple-500 text-white py-2 px-4 rounded">Search GIF</button>
    <div id="gifSearchResults" class="grid grid-cols-4 gap-2 mt-2 hidden"></div>
    <input type="hidden" id="selectedGif" />
